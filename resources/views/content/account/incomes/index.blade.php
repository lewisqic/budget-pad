...
@section('content')
    ...
    <div class="content card">
        <div class="card-body">
            ...
            <table id="list_income_table" class="dataTable table table-striped table-hover" data-url="{{ url('account/incomes/data') }}" data-params='{"start_date": "{{ $initial_dates[0] }}", "end_date": "{{ $initial_dates[1] }}", "category_id": {{ $category->id ?? 0 }}}'>
                <thead>
                    <tr>
